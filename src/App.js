...
class App extends Component {
    ...
    handleCreatePalette = (newPalette) => {
        this.setState(
            { colorPalette: [...this.state.colorPalette, newPalette] },
            this.saveDataLs
        );
    };
    deletePalette = (id) => {
        this.setState(
            (st) => ({
                colorPalette: st.colorPalette.filter(
    ...
    saveDataLs = () => {
        localStorage.setItem(
            'palette',
            JSON.stringify(this.state.colorPalette)
        );
    };
    render() {
            ...
            <div className='App'>
                <Switch>
                    <Route
                        ...
                        render={({ match }) => (
                            <CreateNewPalette
                                handleSave={this.handleCreatePalette}
                    ...
                    <Route
                        ...
                        render={(routingOpt) => (
                            <Home
                                ...
                                handleDeletePalette={this.deletePalette}
                                {...routingOpt}
                            />
                        )}
                    />
                        ...
                        render={({ match }) => (
                            <ColorPalette
                                palette={ColorShadGenerator(
                                    findPalette(colorPalette, match.params.id)
                                )}
                            />
                        )}
                    />
